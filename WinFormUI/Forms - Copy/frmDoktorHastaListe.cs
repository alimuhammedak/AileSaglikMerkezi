...
namespace WinFormUI.Forms
{
    public partial class frmDoktorHastaListe : Form
    {
        ...
        private void frmHastaKayit_Load(object sender, EventArgs e)
        {
            ...
            string rasgeleDize = Guid.NewGuid().ToString().Replace("-", "").Substring(0, 8).ToUpper();
            LblProtokolNo.Text = rasgeleDize;
            ...
            var doktorBilgileri = result.Data.Select(s => new { Ad = s.Doktor.Kullanici.ad, Soyad = s.Doktor.Kullanici.soyad, Unvan = s.Doktor.Unvan.ad }).ToList();
